...
import { Mail, Lock, ArrowRight, Loader2, User, ShieldCheck, BarChart3, Globe2, Eye, EyeOff } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 sm:p-6 md:p-12 overflow-hidden bg-background">
      <div className="container max-w-7xl z-10 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-center">
          ...
          <div className="flex flex-col items-center text-center space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h1 className="text-3xl sm:text-5xl lg:text-7xl font-black tracking-tighter text-foreground uppercase leading-[0.9] font-display">
                  SOLAR<br />
                  <span className="text-gradient-solar">POWER</span>
                </h1>
                <p className="text-base sm:text-xl lg:text-2xl font-medium text-muted-foreground leading-relaxed max-w-md">
          ...
          <div className="relative group animate-in fade-in slide-in-from-right-8 duration-1000">
            ...
            <div className="absolute -inset-px bg-linear-to-r from-solar-orange via-solar-amber to-solar-green rounded-2xl sm:rounded-[3rem] blur opacity-20 group-hover:opacity-40 transition duration-700"></div>

            <div className="relative bg-white text-black dark:bg-gray-900 dark:text-white border border-border/50 rounded-2xl sm:rounded-[3rem] overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.2)]">
              <div className="p-6 sm:p-10 md:p-14">
                <div className="mb-8 sm:mb-12">
                  <h2 className="text-2xl sm:text-3xl font-black mb-3">Admin Login</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="space-y-3">
                    ...
                    <div className="relative group/input">
                      ...
                      <input
                        ...
                        className="w-full bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 focus:border-solar-amber/50 focus:ring-8 focus:ring-solar-amber/5 rounded-xl sm:rounded-2xl px-12 sm:px-14 py-4 sm:py-5 outline-none transition-all placeholder:text-gray-300 dark:placeholder:text-gray-600 font-bold text-base sm:text-lg"
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative group/input">
                      ...
                      <button
                        ...
                        className="absolute right-5 top-1/2 -translate-y-1/2 text-gray-300 dark:text-gray-600 hover:text-solar-orange transition-colors"
                      >
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-black text-white dark:bg-white dark:text-black hover:opacity-90 font-black h-14 sm:h-16 rounded-xl sm:rounded-2xl shadow-2xl transition-all hover:translate-y-[-2px] active:translate-y-px mt-4 flex items-center justify-center gap-3 sm:gap-4 group/btn" 
                    disabled={loading}
                  >
                    {loading ? (
                      ...
                      <>
                        <span className="text-base sm:text-xl tracking-tighter">AUTHORIZE ACCESS</span>
              ...
              <div className="bg-gray-50/50 dark:bg-gray-800/20 px-6 sm:px-10 py-4 sm:py-6 text-center border-t border-gray-50 dark:border-gray-800">
